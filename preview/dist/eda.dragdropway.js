...
/***/ (function(module, exports) {
	...
	function formlyConfig(formlyConfigProvider, EasyFormGenFormlyBindingModelsProvider, easyFormDragWayConfigProvider) {
	    ...
	    var angularUIDateTimePickerTemplate = '\n        <p class="input-group">\n            <span class="input-group-btn">\n                <button\n                    type="button"\n                    class="btn btn-default"\n                    ng-click="datepicker.open($event)">\n                    <i class="glyphicon glyphicon-calendar"></i>\n                </button>\n            </span>\n            <input\n                type="text"\n                id="{{::id}}"\n                name="{{::id}}"\n                ng-model="model[options.key]"\n                class="form-control"\n            />\n        </p>\n    ';
	    ...
	    formlyConfigProvider.setType({
	        ...
	        link: function link(scope, element, attrs, ngModelCtrl) {
	            ...
	            var dpickerDiv = $(element).find(".input-group input");
	            window.setTimeout(function () {
	                var dpicker = dpickerDiv.datepicker({
	    ...
	    formlyConfigProvider.setType({
	        ...
	        link: function link(scope, element, attrs, ngModelCtrl) {
	            var parent = $(element).parent();
	            var datepickerDiv = $(element).find(".input-group input");
	            window.setTimeout(function () {
	                var dtp = datepickerDiv.datetimepicker({
	    ...
	    formlyConfigProvider.setType({
	        ...
	        link: function link(scope, element, attrs, ngModelCtrl) {
	            window.setTimeout(function () {
	                var all = $(element).find("select#" + $(element).find("select").attr("id"));
	                var select = $(element).find("select");
	                var sel = select.select2({ width: '100%' });
	    ...
	    formlyConfigProvider.setType({
	        ...
	        controller: function controller($scope) {
	            ...
	            var _groups = $scope.options.templateOptions.options.sort(function (a, b) {
	                if (a.order > b.order) {
	                    return 1;
	                }
	                if (a.order < b.order) {
	            ...
	            $scope.DisplayOptions = Object.keys(_groups).map(function (k) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _edaDragDropWayLeftpanelEmailControl = __webpack_require__(27);
	
	var _edaDragDropWayLeftpanelEmailControl2 = _interopRequireDefault(_edaDragDropWayLeftpanelEmailControl);
	
	var _edaDragDropWayLeftpanelNumberInputControl = __webpack_require__(29);
	
	var _edaDragDropWayLeftpanelNumberInputControl2 = _interopRequireDefault(_edaDragDropWayLeftpanelNumberInputControl);
	
	var _edaDragDropWayLeftpanelTextareaControl = __webpack_require__(31);
	
	var _edaDragDropWayLeftpanelTextareaControl2 = _interopRequireDefault(_edaDragDropWayLeftpanelTextareaControl);
	
	var _edaDragDropWayLeftpanelSubtitleControl = __webpack_require__(33);
	
	var _edaDragDropWayLeftpanelSubtitleControl2 = _interopRequireDefault(_edaDragDropWayLeftpanelSubtitleControl);
	
	var _edaDragDropWayLeftpanelRichTextEditorControl = __webpack_require__(35);
	
	var _edaDragDropWayLeftpanelRichTextEditorControl2 = _interopRequireDefault(_edaDragDropWayLeftpanelRichTextEditorControl);
	
	var _edaDragDropWayLeftpanelRadioControl = __webpack_require__(37);
	
	var _edaDragDropWayLeftpanelRadioControl2 = _interopRequireDefault(_edaDragDropWayLeftpanelRadioControl);
	
	var _edaDragDropWayLeftpanelHeaderControl = __webpack_require__(39);
	
	var _edaDragDropWayLeftpanelHeaderControl2 = _interopRequireDefault(_edaDragDropWayLeftpanelHeaderControl);
	
	var _edaDragDropWayLeftpanelGroupedSelectControl = __webpack_require__(41);
	
	var _edaDragDropWayLeftpanelGroupedSelectControl2 = _interopRequireDefault(_edaDragDropWayLeftpanelGroupedSelectControl);
	
	var _edaDragDropWayLeftpanelDateControl = __webpack_require__(43);
	
	var _edaDragDropWayLeftpanelDateControl2 = _interopRequireDefault(_edaDragDropWayLeftpanelDateControl);
	
	var _edaDragDropWayLeftpanelDatetimeControl = __webpack_require__(45);
	
	var _edaDragDropWayLeftpanelDatetimeControl2 = _interopRequireDefault(_edaDragDropWayLeftpanelDatetimeControl);
	
	var _edaDragDropWayLeftpanelCheckBoxControl = __webpack_require__(47);
	
	var _edaDragDropWayLeftpanelCheckBoxControl2 = _interopRequireDefault(_edaDragDropWayLeftpanelCheckBoxControl);
	
	var _edaDragDropWayLeftpanelBlankControl = __webpack_require__(49);
	
	var _edaDragDropWayLeftpanelBlankControl2 = _interopRequireDefault(_edaDragDropWayLeftpanelBlankControl);
	
	var _edaDragDropWayLeftpanelBasicSelectControl = __webpack_require__(51);
	
	var _edaDragDropWayLeftpanelBasicSelectControl2 = _interopRequireDefault(_edaDragDropWayLeftpanelBasicSelectControl);
	
	var _edaDragDropWayLeftpanelRepeatGroup = __webpack_require__(53);
	
	var _edaDragDropWayLeftpanelRepeatGroup2 = _interopRequireDefault(_edaDragDropWayLeftpanelRepeatGroup);
	...
	/* global angular */
	var LEFT_PANEL_MODULE = 'edaDragDropWay.leftPanel.module';
	
	exports.default = angular.module(LEFT_PANEL_MODULE, []).directive(_edaDragDropWayLeftPanel3.LEFT_PANEL_DIRECTIVE, _edaDragDropWayLeftPanel4.default).controller(_edaDragDropWayLeftPanel.LEFT_PANEL_CONTROLLER, _edaDragDropWayLeftPanel2.default).service(_edaDragDropWayLeftPanelSelectOptionManage.LEFT_PANEL_SELECT_OPTION_MANAGE_SERVICE, _edaDragDropWayLeftPanelSelectOptionManage2.default).service(_edaDragDropWayLeftPanelControllerModalProxy.CONTROLLER_MODAL_PROXY, _edaDragDropWayLeftPanelControllerModalProxy2.default).directive(_edaDragDropWayLeftpanelValidEditFooter.LEFT_PANEL_VALID_EDIT_FOOTER_DIRECTIVE, _edaDragDropWayLeftpanelValidEditFooter2.default).directive(_edaDragDropWayLeftpanelTextInputControl.LEFT_PANEL_TEXT_INPUT_CONTROL_DIRECTIVE, _edaDragDropWayLeftpanelTextInputControl2.default).directive(_edaDragDropWayLeftpanelEmailControl.LEFT_PANEL_EMAIL_CONTROL_DIRECTIVE, _edaDragDropWayLeftpanelEmailControl2.default).directive(_edaDragDropWayLeftpanelNumberInputControl.LEFT_PANEL_NUMBER_INPUT_CONTROL_DIRECTIVE, _edaDragDropWayLeftpanelNumberInputControl2.default).directive(_edaDragDropWayLeftpanelTextareaControl.LEFT_PANEL_TEXTAREA_CONTROL_DIRECTIVE, _edaDragDropWayLeftpanelTextareaControl2.default).directive(_edaDragDropWayLeftpanelSubtitleControl.LEFT_PANEL_SUBTITLE_CONTROL_DIRECTIVE, _edaDragDropWayLeftpanelSubtitleControl2.default).directive(_edaDragDropWayLeftpanelRichTextEditorControl.LEFT_PANEL_RICH_TEXT_EDITOR_CONTROL_DIRECTIVE, _edaDragDropWayLeftpanelRichTextEditorControl2.default).directive(_edaDragDropWayLeftpanelRadioControl.LEFT_PANEL_RADIO_CONTROL_DIRECTIVE, _edaDragDropWayLeftpanelRadioControl2.default)
	// .directive(LEFT_PANEL_PASSWORD_CONTROL_DIRECTIVE, leftPanelPasswordControl)
	.directive(_edaDragDropWayLeftpanelHeaderControl.LEFT_PANEL_HEADER_CONTROL_DIRECTIVE, _edaDragDropWayLeftpanelHeaderControl2.default).directive(_edaDragDropWayLeftpanelGroupedSelectControl.LEFT_PANEL_GROUPED_SELECT_CONTROL_DIRECTIVE, _edaDragDropWayLeftpanelGroupedSelectControl2.default).directive(_edaDragDropWayLeftpanelDateControl.LEFT_PANEL_DATE_CONTROL_DIRECTIVE, _edaDragDropWayLeftpanelDateControl2.default).directive(_edaDragDropWayLeftpanelDatetimeControl.LEFT_PANEL_DATETIME_CONTROL_DIRECTIVE, _edaDragDropWayLeftpanelDatetimeControl2.default).directive(_edaDragDropWayLeftpanelCheckBoxControl.LEFT_PANEL_CHECKBOX_CONTROL_DIRECTIVE, _edaDragDropWayLeftpanelCheckBoxControl2.default).directive(_edaDragDropWayLeftpanelBlankControl.LEFT_PANEL_BLANK_CONTROL_DIRECTIVE, _edaDragDropWayLeftpanelBlankControl2.default).directive(_edaDragDropWayLeftpanelBasicSelectControl.LEFT_PANEL_BASIC_SELECT_CONTROL_DIRECTIVE, _edaDragDropWayLeftpanelBasicSelectControl2.default).directive(_edaDragDropWayLeftpanelRepeatGroup.LEFT_PANEL_REPEAT_GROUP_DIRECTIVE, _edaDragDropWayLeftpanelRepeatGroup2.default);
	...
	var leftPanelController = function () {
	    ...
	    _createClass(leftPanelController, [{
	        ...
	        value: function addNewOptionMultiSelect() {
	            var result = this.$selectOptionMange.addNewOptionMultiSelect(this.multiSelectRowCollection, this.newOptionMultiSelect.saisie, '');
	            if (result.resultFlag === false) {
	                this.toaster.pop({
	                    type: 'warning',
	                    timeout: 2000,
	        ...
	        value: function removeMultiSelectRow(index) {
	            var result = this.selectOptionMangage.removeOption(this.multiSelectRowCollection, index);
	            if (result.resultFlag === false) {
	                this.toaster.pop({
	                    type: 'warning',
	                    timeout: 2000,
	        ...
	        value: function upThisMultiSelectRow(index) {
	            var result = this.selectOptionMangage.upthisOption(this.multiSelectRowCollection, index);
	            if (result.resultFlag === false) {
	                this.toaster.pop({
	                    type: 'warning',
	                    timeout: 2000,
	        ...
	        value: function downThisMultiSelectRow(index) {
	            var result = this.selectOptionMangage.downthisOption(this.multiSelectRowCollection, index);
	        ...
	        value: function openDateTimePicker($event) {
	            $event.preventDefault();
	            $event.stopPropagation();
	            this.demodttime.opened = true;
	        }
	    }, {
	        key: 'initRepeatSectionFields',
	        value: function initRepeatSectionFields() {
	            return [{
	                type: 'repeatSection',
	                key: 'investments',
	                templateOptions: {
	...
	var controllerModalProxy = function () {
	    ...
	    _createClass(controllerModalProxy, [{
	        ...
	        value: function init() {
	            ...
	            this.newOptionMultiSelect = angular.copy({ saisie: '' });
	            this.MultiSelectGroups = angular.copy({ list: [] });
	            this.newGroupMultiSelect = angular.copy({ saisie: '' });
	        ...
	        key: 'initRepeatSectionModel',
	        value: function initRepeatSectionModel() {
	            return {
	                investments: [{
	                    investmentName: 'abc',
	        ...
	        key: 'initRepeatSectionOptions',
	        value: function initRepeatSectionOptions() {
	            return {};
	        }
	    }, {
	        key: 'initRepeatSectionForm',
	        value: function initRepeatSectionForm() {
	            return {};
	        }
	        ...
	        value: function returnControlFromAddCtrlModalModel(CtrlModalModel) {
	            ...
	            for (var i = CtrlModalModel.controls.length - 1; i >= 0; i--) {
	                if (CtrlModalModel.selectedControl === CtrlModalModel.controls[i].id) {
	                    ...
	                    if (CtrlModalModel.controls[i].formlyType === 'datetimepicker') modelToReturn.datetimepickerPopup = CtrlModalModel.controls[i].datetimepickerPopup;
	                }
	            }
	        ...
	        value: function bindConfigurationModelFromProxyModel(indexLine, numcolumn, configurationObj) {
	            ...
	            // add additional - particular - properties : -> datetimepicker : datetimepickerPopup
	            if (configurationObj.lines[indexLine].columns[numcolumn].control.type === 'datetimepicker') {
	                configurationObj.lines[indexLine].columns[numcolumn].control.templateOptions.datetimepickerPopup = extractedProps.datetimepickerPopup;
	            }
	        ...
	        value: function setProxyModelFromConfigurationSelection(configurationObj, indexLine, numcolumn) {
	            ...
	            if (typeof configurationObj.lines[indexLine].columns[numcolumn].control != 'undefined') {
	                ...
	                // particular case: datetimepicker
	                if (this.proxyModel.temporyConfig.selectedControl === 'DateTime') {
	                    this.proxyModel.temporyConfig.datetimepickerPopup = typeof configurationObj.lines[indexLine].columns[numcolumn].control.templateOptions.datetimepickerPopup != 'undefined' ? configurationObj.lines[indexLine].columns[numcolumn].control.templateOptions.datetimepickerPopup : '';
	                }
	        ...
	        value: function bindSpecialCtrlTemporyModelsToProxyModel() {
	            ...
	            if (this.proxyModel.selectedControl === 'oldGroupedSelect') {
	        ...
	        key: 'bindMultiSelectFromProxyModel',
	        value: function bindMultiSelectFromProxyModel(multiSelectRowCollection) {
	            if (this.proxyModel.temporyConfig.formlyOptions.length > 0) {
	                for (var i = 0; i <= this.proxyModel.temporyConfig.formlyOptions.length - 1; i++) {
	                    var newOption = {
	                        'option': this.proxyModel.temporyConfig.formlyOptions[i].option,
	                        'order': i,
	                        'group': this.proxyModel.temporyConfig.formlyOptions[i].group
	                    };
	                    multiSelectRowCollection.rows.push(newOption);
	                }
	                var filteredgroup = _.uniq(_.pluck(multiSelectRowCollection.rows, 'group'));
	        ...
	        key: 'bindMultiSelectToProxyModel',
	        value: function bindMultiSelectToProxyModel(multiSelectRowCollection) {
	            this.proxyModel.temporyConfig.formlyOptions = this.multiSelectRowCollection.rows || [];
	        }
	        ...
	        key: 'bindRepeatSectionToProxyModel',
	        value: function bindRepeatSectionToProxyModel() {
	            var fields = this.repeatSectionFields.reduce(function () {
	            ...
	            this.proxyModel.temporyConfig.formlyOptions = [this.repeatSectionModel.investments, fields[0].templateOptions];
	        }
	    }, {
	        ...
	        key: 'set_select3function',
	        value: function set_select3function() {
	            setTimeout(function () {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.LEFT_PANEL_EMAIL_CONTROL_DIRECTIVE = undefined;
	
	var _edaDragDropWayLeftpanelEmailControlTemplate = __webpack_require__(28);
	
	var _edaDragDropWayLeftpanelEmailControlTemplate2 = _interopRequireDefault(_edaDragDropWayLeftpanelEmailControlTemplate);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var LEFT_PANEL_EMAIL_CONTROL_DIRECTIVE = 'leftPanelEmailControl';
	
	function leftPanelEmailControl() {
	    var directive = {
	        restrict: 'E',
	        template: _edaDragDropWayLeftpanelEmailControlTemplate2.default
	    };
	    return directive;
	}
	...
	exports.default = leftPanelEmailControl;
	exports.LEFT_PANEL_EMAIL_CONTROL_DIRECTIVE = LEFT_PANEL_EMAIL_CONTROL_DIRECTIVE;

/***/ }),
/* 28 */
/***/ (function(module, exports) {

	module.exports = "<div class=\"panel panel-default\">\n    <div class=\"panel-body\">\n        <div class=\"row\">\n            <div class=\"col-md-12\">\n                <h5 class=\"greyText\">\n                    <i class=\"fa fa-pencil-square-o\"></i> &nbsp; Edit properties :\n                </h5>\n            </div>\n        </div>\n        <div class=\"marginTopFivepixels\"></div>\n        <div class=\"row\">\n            <div class=\"form-group\">\n                <div class=\"col-md-12\">\n                    <label for=\"inputEmailLabelUpdate\" class=\" control-label greyText editPropertiesLabel\">\n            Label text :\n            </label>\n                    <div class=\"\">\n                        <input type=\"text\" class=\"form-control\" ng-model=\"leftPanelCtrl.proxyModel.temporyConfig.formlyLabel\" id=\"inputEmailLabelUpdate\" placeholder=\"Add / edit control label here\">\n                    </div>\n                </div>\n            </div>\n        </div>\n        <div class=\"marginTopFivepixels\"></div>\n        <div class=\"row\">\n            <div class=\"form-group\">\n                <div class=\"col-md-12\">\n                    <label for=\"inputEmailplaceholderUpdate\" class=\"control-label greyText editPropertiesLabel\">\n            placeholder :\n          </label>\n                    <div class=\"\">\n                        <input type=\"text\" class=\"form-control\" ng-model=\"leftPanelCtrl.proxyModel.temporyConfig.formlyPlaceholder\" id=\"inputEmailplaceholderUpdate\" placeholder=\"Add / edit placeholder text here\">\n                    </div>\n                </div>\n            </div>\n        </div>\n        <div class=\"marginTopFivepixels\"></div>\n        <div class=\"row\">\n            <div class=\"form-group\">\n                <div class=\"\">\n                    <label for=\"inputEmailRequiredUpdate\" class=\"col-md-4 control-label greyText editPropertiesLabel\">\n            Required :\n          </label>\n                    <div class=\"col-md-8\">\n                        <div class=\"checkboxCssCorrection\">&nbsp;</div>\n                        <input type=\"checkbox\" ng-model=\"leftPanelCtrl.proxyModel.temporyConfig.formlyRequired\" id=\"inputEmailRequiredUpdate\">\n                    </div>\n                </div>\n            </div>\n        </div>\n        <div class=\"marginTopFivepixels\"></div>\n        <div class=\"row\">\n            <div class=\"form-group\">\n                <div class=\"col-md-12\">\n                    <label for=\"inputEmailDescriptionUpdate\" class=\"control-label greyText editPropertiesLabel\">\n            Description :\n          </label>\n                    <div class=\"\">\n                        <input type=\"text\" class=\"form-control\" ng-model=\"leftPanelCtrl.proxyModel.temporyConfig.formlyDescription\" id=\"inputEmailDescriptionUpdate\" placeholder=\"Add / edit description here\">\n                    </div>\n                </div>\n            </div>\n        </div>\n    </div>\n    <left-panel-valid-edit-footer />\n</div>"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.LEFT_PANEL_NUMBER_INPUT_CONTROL_DIRECTIVE = undefined;
	
	var _edaDragDropWayLeftpanelNumberInputControlTemplate = __webpack_require__(30);
	
	var _edaDragDropWayLeftpanelNumberInputControlTemplate2 = _interopRequireDefault(_edaDragDropWayLeftpanelNumberInputControlTemplate);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var LEFT_PANEL_NUMBER_INPUT_CONTROL_DIRECTIVE = 'leftPanelNumberInputControl';
	
	function leftPanelNumberInputControl() {
	    var directive = {
	        restrict: 'E',
	        template: _edaDragDropWayLeftpanelNumberInputControlTemplate2.default
	    };
	    return directive;
	}
	...
	exports.default = leftPanelNumberInputControl;
	exports.LEFT_PANEL_NUMBER_INPUT_CONTROL_DIRECTIVE = LEFT_PANEL_NUMBER_INPUT_CONTROL_DIRECTIVE;

/***/ }),
/* 30 */
/***/ (function(module, exports) {

	module.exports = "<div class=\"panel panel-default\">\n    <div class=\"panel-body\">\n        <div class=\"row\">\n            <div class=\"col-md-12\">\n                <h5 class=\"greyText\">\n                    <i class=\"fa fa-pencil-square-o\"></i> &nbsp; Edit properties :\n                </h5>\n            </div>\n        </div>\n        <div class=\"marginTopFivepixels\"></div>\n        <div class=\"row\">\n            <div class=\"form-group\">\n                <div class=\"col-md-12\">\n                    <label for=\"inputNumberLabelUpdate\" class=\" control-label greyText editPropertiesLabel\">\n            Label text :\n            </label>\n                    <div class=\"\">\n                        <input type=\"text\" class=\"form-control\" ng-model=\"leftPanelCtrl.proxyModel.temporyConfig.formlyLabel\" id=\"inputNumberLabelUpdate\" placeholder=\"Add / edit control label here\">\n                    </div>\n                </div>\n            </div>\n        </div>\n        <div class=\"marginTopFivepixels\"></div>\n        <div class=\"row\">\n            <div class=\"form-group\">\n                <div class=\"col-md-12\">\n                    <label for=\"inputNumberplaceholderUpdate\" class=\"control-label greyText editPropertiesLabel\">\n            placeholder :\n          </label>\n                    <div class=\"\">\n                        <input type=\"text\" class=\"form-control\" ng-model=\"leftPanelCtrl.proxyModel.temporyConfig.formlyPlaceholder\" id=\"inputNumberplaceholderUpdate\" placeholder=\"Add / edit placeholder text here\">\n                    </div>\n                </div>\n            </div>\n        </div>\n        <div class=\"marginTopFivepixels\"></div>\n        <div class=\"row\">\n            <div class=\"form-group\">\n                <div class=\"\">\n                    <label for=\"inputNumberRequiredUpdate\" class=\"col-md-4 control-label greyText editPropertiesLabel\">\n            Required :\n          </label>\n                    <div class=\"col-md-8\">\n                        <div class=\"checkboxCssCorrection\">&nbsp;</div>\n                        <input type=\"checkbox\" ng-model=\"leftPanelCtrl.proxyModel.temporyConfig.formlyRequired\" id=\"inputNumberRequiredUpdate\">\n                    </div>\n                </div>\n            </div>\n        </div>\n        <div class=\"marginTopFivepixels\"></div>\n        <div class=\"row\">\n            <div class=\"form-group\">\n                <div class=\"col-md-12\">\n                    <label for=\"inputNumberDescriptionUpdate\" class=\"control-label greyText editPropertiesLabel\">\n            Description :\n          </label>\n                    <div class=\"\">\n                        <input type=\"text\" class=\"form-control\" ng-model=\"leftPanelCtrl.proxyModel.temporyConfig.formlyDescription\" id=\"inputNumberDescriptionUpdate\" placeholder=\"Add / edit description here\">\n                    </div>\n                </div>\n            </div>\n        </div>\n    </div>\n    <left-panel-valid-edit-footer />\n</div>"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _edaDragDropWayLeftpanelTextareaControlTemplate = __webpack_require__(32);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _edaDragDropWayLeftpanelSubtitleControlTemplate = __webpack_require__(34);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _edaDragDropWayLeftpanelRichTextEditorControlTemplate = __webpack_require__(36);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _edaDragDropWayLeftpanelRadioControlTemplate = __webpack_require__(38);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _edaDragDropWayLeftpanelHeaderControlTemplate = __webpack_require__(40);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _edaDragDropWayLeftpanelGroupedSelectControlTemplate = __webpack_require__(42);
...
/***/ (function(module, exports) {
	...
	module.exports = "<div class=\"panel panel-default\">\n    <div class=\"panel-body\">\n        <div class=\"row\">\n            <div class=\"col-md-12\">\n                <h5 class=\"greyText\">\n                    <i class=\"fa fa-pencil-square-o\"></i> &nbsp; Edit properties :\n                </h5>\n            </div>\n        </div>\n        <div class=\"marginTopFivepixels\"></div>\n        <div class=\"row\">\n            <div class=\"col-lg-12 col-md-12\">\n                <label for=\"multiSelectRowCollection\" class=\"control-label greyText editPropertiesLabel\">\n            Add new options :\n          </label>\n            </div>\n        </div>\n        <div class=\"row\">\n            <div>\n                <div class=\"form-group\">\n                    <div class=\"col-sm-9 col-xs-9 col-md-9 col-lg-9\">\n                        <input type=\"text\" class=\"form-control\" id=\"inputAddNewMultiOption\" placeholder=\"add new option\" ng-model=\"leftPanelCtrl.newOptionMultiSelect.saisie\">\n                    </div>\n                    <div class=\"col-sm-3 col-xs-3 col-md-3 col-lg-3\">\n                        <button class=\"btn btn-primary\" ng-click=\"leftPanelCtrl.addNewOptionMultiSelect()\">\n                add\n              </button>\n                    </div>\n                </div>\n            </div>\n        </div>\n        <div class=\"row\">\n            <div class=\"col-lg-12 col-md-12\">\n                <label for=\"multiSelectRowCollection\" class=\" control-label greyText editPropertiesLabel\">\n            Add new groups :\n          </label>\n            </div>\n        </div>\n        <div class=\"row\">\n            <div>\n                <div class=\"form-group\">\n                    <div class=\"col-sm-9 col-xs-9 col-md-9 col-lg-9\">\n                        <input id=\"inputAddNewGroupMultiOption\" type=\"text\" class=\"form-control\" ng-model=\"leftPanelCtrl.newGroupMultiSelect.saisie\" placeholder=\"Add new group\">\n                    </div>\n                    <div class=\"col-sm-3 col-xs-3 col-md-3 col-lg-3\">\n                        <button class=\"btn btn-primary\" ng-click=\"leftPanelCtrl.addNewGroupToMultiSelect()\">\n                add\n              </button>\n                    </div>\n                </div>\n            </div>\n        </div>\n        <div class=\"row\">\n            <div class=\"col-lg-12 col-md-12\">\n                <label class=\" control-label greyText editPropertiesLabel\">\n            Edit/Remove options/groups:\n          </label>\n            </div>\n        </div>\n        <div class=\"row\">\n            <div class=\"form-group\">\n                <div class- \"col-lg-12 col-md-12 col-sm-12 col-xs-12\">\n                    <div class=\"container\">\n                        <div ng-if=\"leftPanelCtrl.multiSelectRowCollection.rows.length === 0\">\n                            <h5 class=\"text-center greyText\">\n                                <em>\n                    - no option : add new options -\n                  </em>\n                            </h5>\n                        </div>\n                        <table ng-if=\"leftPanelCtrl.multiSelectRowCollection.rows.length > 0\" class=\"table table-striped\">\n                            <thead>\n                                <tr>\n                                    <th st-ratio=\"20\">\n                                        order\n                                    </th>\n                                    <th st-ratio=\"25\">\n                                        group\n                                    </th>\n                                    <th st-ratio=\"30\">\n                                        option\n                                    </th>\n                                    <th st-ratio=\"25\"></th>\n                                </tr>\n                                <tr>\n                                    <th st-ratio=\"20\"></th>\n                                    <th st-ratio=\"25\"></th>\n                                    <th st-ratio=\"30\">\n                                        <input ng-model=\"multiSelectFilter\" placeholder=\"search for option\" class=\"input-sm form-control\" type=\"search\" />\n                                    </th>\n                                    <th st-ratio=\"25\"></th>\n                                </tr>\n                            </thead>\n                            <tbody>\n                                <tr ng-repeat=\"multiSelectRow in leftPanelCtrl.multiSelectRowCollection.rows | filter:multiSelectFilter as multiSelectRow\">\n                                    <td st-ratio=\"20\">\n                                        {{$index}}\n                                    </td>\n                                    <td st-ratio=\"25\">\n                                        <div ng-if=\"leftPanelCtrl.groupSelectGroupClick.showList === true\">\n                                            <div ng-if=\"leftPanelCtrl.MultiSelectGroups.list.length === 0\">\n                                                <p class=\"text-left noGroupText\">\n                                                    - add new groups -\n                                                </p>\n                                            </div>\n                                            <div ng-if=\"leftPanelCtrl.MultiSelectGroups.list.length > 0\">\n                                                <ol class=\"nya-bs-select col-sm-12 col-xs-12 col-md-12 col-lg12 editMultiSelectnyaSelect\" ng-model=\"multiSelectRow.group\" id=\"modelMultiOptionMultiChoose\" disabled=\"leftPanelCtrl.MultiSelectGroups.list.length === 0\">\n                                                    <li class=\"nya-bs-option\" nya-bs-option=\"MultiSelectGroup in leftPanelCtrl.MultiSelectGroups.list\" value=\"MultiSelectGroup\">\n                                                        <a>\n                              {{MultiSelectGroup}}\n                            </a>\n                                                    </li>\n                                                </ol>\n                                            </div>\n                                        </div>\n                                        <div ng-if=\"leftPanelCtrl.groupSelectGroupClick.showList === false\">\n                                            {{multiSelectRow.group}}\n                                        </div>\n                                    </td>\n                                    <td st-ratio=\"30\">\n                                        {{multiSelectRow.option}}\n                                    </td>\n                                    <td st-ratio=\"25\">\n                                        <div class=\"pull-right\">\n                                            <button class=\"btn btn-primary\" ng-click=\"leftPanelCtrl.upThisMultiSelectRow($index)\">\n                        <i class=\"fa fa-arrow-up\"></i>\n                      </button>\n                                            <button class=\"btn btn-primary\" ng-click=\"leftPanelCtrl.downThisMultiSelectRow($index)\">\n                        <i class=\"fa fa-arrow-down\"></i>\n                      </button>\n                                            <button class=\"btn btn-warning\" ng-click=\"leftPanelCtrl.showGroupListToChoose()\">\n                        <i class=\"fa fa-pencil-square-o\"></i>\n                      </button>\n                                            <button class=\"btn btn-danger\" ng-click=\"leftPanelCtrl.removeMultiSelectRow($index)\">\n                        <i class=\"fa fa-trash-o\"></i>\n                      </button>\n                                        </div>\n                                    </td>\n                                </tr>\n                            </tbody>\n                        </table>\n                    </div>\n                </div>\n            </div>\n        </div>\n        <div class=\"marginTopFivepixels\"></div>\n        <div class=\"row\">\n            <div class=\"form-group\">\n                <div class=\"col-md-12\">\n                    <label for=\"DescriptionUpdate\" class=\"control-label greyText editPropertiesLabel\">\n              Description :\n            </label>\n                    <div class=\"\">\n                        <input type=\"text\" class=\"form-control\" ng-model=\"leftPanelCtrl.proxyModel.temporyConfig.formlyDescription\" id=\"DescriptionUpdate\" placeholder=\"Add / edit description here\">\n                    </div>\n                </div>\n            </div>\n        </div>\n    </div>\n    <left-panel-valid-edit-footer />\n</div>"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _edaDragDropWayLeftpanelDateControlTemplate = __webpack_require__(44);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.LEFT_PANEL_DATETIME_CONTROL_DIRECTIVE = undefined;
	
	var _edaDragDropWayLeftpanelDateTimeControlTemplate = __webpack_require__(46);
	
	var _edaDragDropWayLeftpanelDateTimeControlTemplate2 = _interopRequireDefault(_edaDragDropWayLeftpanelDateTimeControlTemplate);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var LEFT_PANEL_DATETIME_CONTROL_DIRECTIVE = 'leftPanelDateTimeControl';
	
	function leftPanelDateTimeControl() {
	    var directive = {
	        restrict: 'E',
	        template: _edaDragDropWayLeftpanelDateTimeControlTemplate2.default
	    };
	    return directive;
	}
	...
	exports.default = leftPanelDateTimeControl;
	exports.LEFT_PANEL_DATETIME_CONTROL_DIRECTIVE = LEFT_PANEL_DATETIME_CONTROL_DIRECTIVE;

/***/ }),
/* 46 */
/***/ (function(module, exports) {

	module.exports = "<div class=\"panel panel-default\">\n    <div class=\"panel-body\">\n        <div class=\"row\">\n            <div class=\"col-md-12\">\n                <h5 class=\"greyText\">\n                    <i class=\"fa fa-pencil-square-o\"></i> &nbsp; Edit properties :\n                </h5>\n            </div>\n        </div>\n        <div class=\"marginTopFivepixels\"></div>\n        <label class=\"control-label greyText editPropertiesLabel\">\n        DateTime format :\n      </label>\n        <div class=\"\">\n            <ol class=\"nya-bs-select col-sm-12 col-xs-12 col-md-12 col-lg12\" ng-model=\"leftPanelCtrl.proxyModel.temporyConfig.datepickerPopup\" id=\"dateformatSelect\">\n                <li class=\"nya-bs-option\" nya-bs-option=\"datetimeformat in leftPanelCtrl.demodttime.formats\" value=\"dateformat\">\n                    <a>\n              {{datetimeformat}}\n            </a>\n                </li>\n            </ol>\n        </div>\n        <div class=\"marginTopFivepixels\"></div>\n        <div class=\"row\">\n            <div class=\"form-group\">\n                <div class=\"col-md-12\">\n                    <label for=\"inputTextLabelUpdate\" class=\" control-label greyText editPropertiesLabel\">\n            Label text :\n          </label>\n                    <div class=\"\">\n                        <input type=\"text\" class=\"form-control\" ng-model=\"leftPanelCtrl.proxyModel.temporyConfig.formlyLabel\" id=\"inputTextLabelUpdate\" placeholder=\"Add / edit control label here\">\n                    </div>\n                </div>\n            </div>\n        </div>\n        <div class=\"marginTopFivepixels\"></div>\n        <div class=\"row\">\n            <div class=\"form-group\">\n                <div class=\"\">\n                    <label for=\"RequiredUpdate\" class=\"col-md-4 control-label greyText editPropertiesLabel\">\n            Required :\n          </label>\n                    <div class=\"col-md-8\">\n                        <div class=\"checkboxCssCorrection\">&nbsp;</div>\n                        <input type=\"checkbox\" ng-model=\"leftPanelCtrl.proxyModel.temporyConfig.formlyRequired\" id=\"RequiredUpdate\">\n                    </div>\n                </div>\n            </div>\n        </div>\n        <div class=\"marginTopFivepixels\"></div>\n        <div class=\"row\">\n            <div class=\"form-group\">\n                <div class=\"col-md-12\">\n                    <label for=\"DescriptionUpdate\" class=\"control-label greyText editPropertiesLabel\">\n            Description :\n          </label>\n                    <div class=\"\">\n                        <input type=\"text\" class=\"form-control\" ng-model=\"leftPanelCtrl.proxyModel.temporyConfig.formlyDescription\" id=\"DescriptionUpdate\" placeholder=\"Add / edit description here\">\n                    </div>\n                </div>\n            </div>\n        </div>\n    </div>\n    <left-panel-valid-edit-footer />\n</div>"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _edaDragDropWayLeftpanelCheckBoxControlTemplate = __webpack_require__(48);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _edaDragDropWayLeftpanelBlankControlTemplate = __webpack_require__(50);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _edaDragDropWayLeftpanelBasicSelectControlTemplate = __webpack_require__(52);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.LEFT_PANEL_REPEAT_GROUP_DIRECTIVE = undefined;
	
	var _edaDragDropWayLeftpanelRepeatGroupTemplate = __webpack_require__(54);
	
	var _edaDragDropWayLeftpanelRepeatGroupTemplate2 = _interopRequireDefault(_edaDragDropWayLeftpanelRepeatGroupTemplate);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
	
	var LEFT_PANEL_REPEAT_GROUP_DIRECTIVE = 'leftPanelRepeatGroup';
	...
	function leftPanelRepeatGroup() {
	    ...
	    var directive = {
	        restrict: 'E',
	        template: _edaDragDropWayLeftpanelRepeatGroupTemplate2.default,
	        controller: (_temp = _class = function repeatGroupController() {
	            _classCallCheck(this, repeatGroupController);
	
	            var vm = this;
	            this.vm = vm;
	            vm.copyRepeatSectionFields = function (fields, index) {
	                fields = angular.copy(fields);
	                vm.addRandomIds(fields, index);
	                return fields;
	            };
	            vm.addRandomIds = function (fields, index) {
	...
	exports.default = leftPanelRepeatGroup;
	exports.LEFT_PANEL_REPEAT_GROUP_DIRECTIVE = LEFT_PANEL_REPEAT_GROUP_DIRECTIVE;

/***/ }),
/* 54 */
/***/ (function(module, exports) {

	module.exports = "<div class=\"panel panel-default\">\n    <div class=\"panel-body\">\n        <div class=\"row\">\n            <div class=\"col-md-12\">\n                <div class=\"form-group\"></div>\n                <div>\n                    <formly-form fields=\"leftPanelCtrl.repeatSectionFields\" model=\"leftPanelCtrl.repeatSectionModel\" form=\"leftPanelCtrl.form\">\n                    </formly-form>\n                </div>\n            </div>\n        </div>\n    </div>\n</div>"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _edaDragDropWayFormlyProxyFormFieldManage = __webpack_require__(56);
	
	var _edaDragDropWayFormlyProxyFormFieldManage2 = _interopRequireDefault(_edaDragDropWayFormlyProxyFormFieldManage);
	
	var _edaDragDropWayFormlyProxyFormFieldManage3 = __webpack_require__(57);
...
/***/ (function(module, exports) {
	...
	var formFieldManage = function () {
	    ...
	    _createClass(formFieldManage, [{
	            ...
	            configurationModel.lines[lineIndex].columns.forEach(function (column) {
	                ...
	                column.control.type !== 'none') {
	                    ...
	                    if (column.control.type === 'header' || column.control.type === 'subTitle') {
	                        ...
	                        if (typeof controlTemplate.templateOptions.datetimepickerPopup !== 'undefined') column.control.templateOptions.datetimepickerPopup = controlTemplate.templateOptions.datetimepickerPopup;
	                    }
	                    /**
	        ...
	        key: 'extractTemplateOptionsDateTimepickerPopup',
	        value: function extractTemplateOptionsDateTimepickerPopup(obj) {
	            return typeof obj.templateOptions !== 'undefined' ? typeof obj.templateOptions.datetimepickerPopup !== 'undefined' ? obj.templateOptions.datetimepickerPopup : '' : '';
	        }
	    }, {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _edaDragDropWayFormlyProxyFormFieldManageProvider = __webpack_require__(58);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _edaDragDropWayDragdropDdDecorContainerTemplate = __webpack_require__(63);
	...
	var _edaDragDropWayDragdropDdDecorContainer = __webpack_require__(64);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _edaDragDropWayDragdropDdDecorDropZoneTemplate = __webpack_require__(66);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _edaDragDropWayDragdropDdDecorItemTemplate = __webpack_require__(68);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _edaDragDropWayDragdropDdDecorLineTemplate = __webpack_require__(71);
	...
	function ddDecorLine($timeout) {
	    ...
	    function linkfct($scope, element, attrs, ctrl, transclude) {
	        ...
	        $scope.setReadyToDelete = function (event) {
	            event.preventDefault();
	            event.stopPropagation();
	            if ($scope.parentIndex === '1') {
...
/***/ (function(module, exports) {
	...
	module.exports = "<div ng-class=\"{confirmLineDelete : deleteLine.readyToDelete}\" ng-mouseover=\"setReadyToDelete($event)\" ng-mouseleave=\"cancelDelete($event);\">\n    <button ng-show=\"deleteLine.readyToDelete === true\" ng-click=\"removeMe($event)\" type=\"button\" class=\"btn btn-danger pull-right buttonCloseLine\">\n     <span\n      class=\"glyphicon glyphicon-trash\"\n      aria-hidden=\"true\">\n    </span>\n  </button>\n</div>\n<div id=\"lineDirectiveTranscludeHere\"></div>"
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _edaDragDropWayRightClick = __webpack_require__(74);
	
	var _edaDragDropWayRightClick2 = _interopRequireDefault(_edaDragDropWayRightClick);
	
	var _edaDragDropWayRightClick3 = __webpack_require__(75);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _edaDragDropWayConfigurationModelProxy = __webpack_require__(77);
	...
	var ddModelConfModelProxyService = function () {
	    ...
	    _createClass(ddModelConfModelProxyService, [{
	        ...
	        value: function bindConfigCtrlModelFromFormlyDetailedCtrlModel(formlyDetailCtrlModel, configurationCtrlModel, configModel) {
	            ...
	            if (this.$parse('control.type')(configurationCtrlModel) === 'datetimepicker') {
	                this.$parse('control.templateOptions.datetimepickerPopup').assign(configurationCtrlModel, this.$parse('datetimepickerPopup')(formlyDetailCtrlModel));
	            }
	        }
	    }]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _dragAndDropListDndlist = __webpack_require__(79);
	
	var _dragAndDropListDndlist2 = _interopRequireDefault(_dragAndDropListDndlist);
	
	var _dragAndDropListDndDraggable = __webpack_require__(80);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _pageslide = __webpack_require__(82);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _edaDragDropWayEdaDragdropWayEasyFormGen = __webpack_require__(84);
	
	var _edaDragDropWayEdaDragdropWayEasyFormGen2 = _interopRequireDefault(_edaDragDropWayEdaDragdropWayEasyFormGen);
	
	var _edaDragDropWayEdaDragdropWayEasyFormGen3 = __webpack_require__(86);
	
	var _edaDragDropWayEdaDragdropWayEasyFormGen4 = _interopRequireDefault(_edaDragDropWayEdaDragdropWayEasyFormGen3);
	
	var _edaDragDropWayEdaDragdropWayEasyFormGen5 = __webpack_require__(88);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _edaDragDropWayEdaDragdropWayEasyFormGenProvider = __webpack_require__(85);
	...
	function easyFormDragWayConfig() {
	    ...
	    function controlsList() {
	        var controls = [{ name: 'empty', enabled: true }, { name: 'Header', enabled: true }, { name: 'Subtitle', enabled: true }, { name: 'TextInput', enabled: true }, { name: 'NumberInput', enabled: true },
	        // {name: 'Password', 				enabled: true},
	        { name: 'Email', enabled: true }, { name: 'Date', enabled: true }, { name: 'DateTime', enabled: true }, { name: 'Texarea', enabled: true }, { name: 'RichTextEditor', enabled: true }, { name: 'Radio', enabled: true }, { name: 'Checkbox', enabled: true }, { name: 'BasicSelect', enabled: true }, { name: 'GroupedSelect', enabled: true }, { name: 'RepeatSection', enabled: true }];
	        return controls;
	    }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _edaDragDropWayEdaDragdropWayEasyFormGenControllerHelpers = __webpack_require__(87);
	            ...
	            if (this.controllerModalProxy.getEditPanelModelToggle()) {
	                ...
	                if (typeof this.controllerModalProxy.getEditPanelModelLineIndex() !== 'undefined' && typeof this.controllerModalProxy.getEditPanelModelColumnIndex() !== 'undefined' && typeof this.controllerModalProxy.getEditPanelModelControl() !== 'undefined') {
	                    if (this.controllerModalProxy.getEditPanelModelLineIndex() === lineIndex && this.controllerModalProxy.getEditPanelModelColumnIndex() === colIndex && angular.equals(this.controllerModalProxy.getEditPanelModelControl(), item)) {
	                        ...
	                        var timerCloseOpenedEditPanel = this.$timeout(function () {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _edaDragDropWayEdaDragdropWayEasyFormGenTemplate = __webpack_require__(89);
	...
	var _edaDragDropWayEdaDragdropWayEasyFormGen = __webpack_require__(86);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _edaDragDropWayTrustThis = __webpack_require__(91);
