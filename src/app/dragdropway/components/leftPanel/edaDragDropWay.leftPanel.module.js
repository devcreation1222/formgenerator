...
import leftPanelEmailControl, {
    LEFT_PANEL_EMAIL_CONTROL_DIRECTIVE
} from './EmailControl/edaDragDropWay.leftpanel.emailControl.directive';
...
import leftPanelDateTimeControl, {
    LEFT_PANEL_DATETIME_CONTROL_DIRECTIVE
} from './DateTimeControl/edaDragDropWay.leftpanel.datetimeControl.directive';
...
import leftPanelRepeatGroup, {
    LEFT_PANEL_REPEAT_GROUP_DIRECTIVE
} from './RepeatGroup/edaDragDropWay.leftpanel.repeatGroup.directive'
...
export default angular
    ...
    .directive(LEFT_PANEL_EMAIL_CONTROL_DIRECTIVE, leftPanelEmailControl)
    ...
    .directive(LEFT_PANEL_DATETIME_CONTROL_DIRECTIVE, leftPanelDateTimeControl)
    ...
    .directive(LEFT_PANEL_REPEAT_GROUP_DIRECTIVE, leftPanelRepeatGroup);